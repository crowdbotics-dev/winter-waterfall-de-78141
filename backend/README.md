...
## Project Structure
    ...
    ├── winter_waterfall_de_78141  # Django project configurations
...
1. Clone this repo and `cd winter_waterfall_de_78141`
...
2. Clone this repo and `cd winter_waterfall_de_78141`
